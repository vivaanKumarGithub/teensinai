    ...
    <Navbar choose={false}/>
      ...
      <div style={{display:"flex", alignItems: "center", justifyContent: "center"}}>
            ...
            <br/><br/>
                ...
                <p style={{ color: "grey"}}>/{calories} ({(todayCals/calories).toFixed(2) * 100}%)</p>
            <p style={{ color: "grey", fontSize: "12px" }}>{Number(todayCals) > Number(calories) ? "Above Calorie Need" : "Below Calorie Need"} <button onClick={() => setTodayCals(0)}className="buttonP">Reset</button></p>
        </div>
