...
const Ask = () => {
  ...
  return (
    <div className="ask">
      ...
      <br/>
      <button style={{ color: 'white', borderRadius: "8px", width: "80px", backgroundColor: "#a9f04b" }} className="buttonC" onClick={AskFunction}>Ask</button>
      <br /><br />
      {result && (
      <>
        <h2 style={{ color: 'black' }}>Answer:</h2>
          ...
          <button onClick={() => location.pathname = "feedback" }className="button">Not giving what you wanted? Give Feedback</button>
      </>  
      )}
    </div>
  )
  ...
  return (
    <div className="feedback">
      ...
      <h3 style={{color: "black"}}>Unhappy with a product? Or just some nice feedback?</h3>
        <p style={{ color: "grey" }}>Give feedback:</p>
      </div>
      <br />
      ...
      <br />
      <br />
      <p style={{ color: "grey" }}>Version 1.0.0 Alpha</p>
